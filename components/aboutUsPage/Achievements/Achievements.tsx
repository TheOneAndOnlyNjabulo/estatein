  ...
  return (
    <div className="mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mt-5 gap-2">
        {/* Grid item 1 starts */}
        <div className="bg-bgsecondary h-[200px] p-2 rounded-lg">
          <div className="rounded-lg bg-background flex-grow py-10 p-5 border border-white/10 shadow-md shadow-white/5 flex flex-col gap-3">
        ...
        {/* Grid item 1 starts */}
        <div className="bg-bgsecondary h-[200px] p-2 rounded-lg">
          <div className="rounded-lg bg-background py-7 p-5 border border-white/10 shadow-md shadow-white/5 flex flex-col gap-3">
        ...
        <div className="bg-bgsecondary  p-2 rounded-lg">
          <div className="rounded-lg h-auto bg-background py-5 p-5 border border-white/10 shadow-md shadow-white/5 flex flex-col gap-3">
